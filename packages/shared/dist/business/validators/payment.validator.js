...
export const validatePaymentBusinessRules = (order) => {
    const errors = [];
...
export const validateSubscriptionBusinessRules = (subscription) => {
    const errors = [];
...
export const validateRefundBusinessRules = (refund, originalAmount) => {
    const errors = [];

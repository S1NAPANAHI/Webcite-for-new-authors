...
export const validateUserBusinessRules = (profile: z.infer<typeof UserProfileSchema>) => {
  const errors: string[] = [];
...
export const validateBetaApplicationBusinessRules = (application: z.infer<typeof BetaApplicationSchema>) => {
  const errors: string[] = [];

  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <Tabs 
        ...
        onSelectionChange={(key: string | number) => setActiveTab(key as LearnSection['section_type'])}
        className="mb-6"
      >
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <Input
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => 
                      setEditingCard({ ...editingCard, action_text: e.target.value })
                    }
                  ...
                  <Input
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => 
                      setEditingCard({ ...editingCard, action_link: e.target.value })
                    }

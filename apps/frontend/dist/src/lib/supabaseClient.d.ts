    ...
    Tables: {
        audit_log: {
            Row: {
                ...
                after: import("./database.types").Json | null;
                before: import("./database.types").Json | null;
        ...
        products: {
            Row: {
                active: boolean;
                content_grants: import("./database.types").Json | null;
                created_at: string;
                description: string | null;
                id: string;
                name: string;
        ...
        webhook_events: {
            Row: {
                id: string;
                payload: import("./database.types").Json;
                provider: string;
        ...
        wiki_content_blocks: {
            Row: {
                content: import("./database.types").Json;
                created_at: string;
                created_by: string | null;
                id: string;
                page_id: string;
    ...
    Functions: {
        create_wiki_page: {
            Args: {
                ...
                p_content: import("./database.types").Json;
                p_excerpt: string;
...
export declare function safeQuery<T>(query: Promise<{
    data: T | null;
    error: Error | null;
}>): Promise<{
    data: T | null;

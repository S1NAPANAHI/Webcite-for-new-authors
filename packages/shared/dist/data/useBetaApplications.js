...
export const useBetaApplications = () => {
    ...
    const updateApplicationStatus = useCallback(async (id, newStatus, notes) => {
    ...
    const updateAdminNotes = useCallback(async (appId, newNotes) => {
...
//# sourceMappingURL=useBetaApplications.js.map
# Reorganize Wiki Migrations
# This script will reorganize the wiki migrations into a standardized structure
...
$wikiDir = Join-Path $rootDir "supabase\migrations\wiki"
